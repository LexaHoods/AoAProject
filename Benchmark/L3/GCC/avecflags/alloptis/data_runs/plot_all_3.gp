...
set title "O1-funroll-loops-ftree-loop-vectorize compiler optimization"
plot "O1-funroll-loops-ftree-loop-vectorize/data/baseline" w lp t "Baseline" , "O1-funroll-loops-ftree-loop-vectorize/data/opt_invariant2" w lp t "opt_invariant2", "O1-funroll-loops-ftree-loop-vectorize/data/opt_inversion" w lp t "opt_inversion","O1-funroll-loops-ftree-loop-vectorize/data/opt_intrinsic" w lp t "opt_intrinsic", "O1-funroll-loops-ftree-loop-vectorize/data/opt_opmp" w lp t "opt_opmp","O1-funroll-loops-ftree-loop-vectorize/data/opt_div" w lp t "opt_div", "O1-funroll-loops-ftree-loop-vectorize/data/opt_invariant" w lp t "opt_invariant"


set title "O2-funroll-loops-ftree-loop-vectorize compiler optimization"
plot "O2-funroll-loops-ftree-loop-vectorize/data/baseline" w lp t "Baseline", "O2-funroll-loops-ftree-loop-vectorize/data/opt_invariant2" w lp t "opt_invariant2", "O2-funroll-loops-ftree-loop-vectorize/data/opt_inversion" w lp t "opt_inversion","O2-funroll-loops-ftree-loop-vectorize/data/opt_intrinsic" w lp t "opt_intrinsic", "O2-funroll-loops-ftree-loop-vectorize/data/opt_opmp" w lp t "opt_opmp", "O2-funroll-loops-ftree-loop-vectorize/data/opt_div" w lp t "opt_div", "O2-funroll-loops-ftree-loop-vectorize/data/opt_invariant" w lp t "opt_invariant"
